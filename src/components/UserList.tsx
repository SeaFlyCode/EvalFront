...
export default function UserList() {
    ...
    // Fonction de chargement des utilisateurs avec useCallback pour éviter les re-créations
    ...
    // Filtrer les utilisateurs avec useMemo pour optimiser les performances
    ...
    // Trier les utilisateurs filtrés avec useMemo
